...
[fromCur, toCur].forEach((select, i) => {
    for (let curCode in Country_List) {
        const selected = (i === 0 && curCode === "USD") || (i === 1 && curCode === "PHP") ? "selected" : "";
...
async function getExchangeRate() {
    ...
    try {
        // Fix the API key and URL format
        const apiKey = '08dc20f6e8531e7b0a9d0c59'; // Replace with your actual API key
